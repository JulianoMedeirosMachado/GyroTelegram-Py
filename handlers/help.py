...
async def help_handler(message: types.Message):
    ...
    "<b>/twitchalert [canal]</b> - Monitora o canal especificado e avisa quando o usuário fica online. (Apenas para administradores em grupos)\n"
    "<b>/removetwitchalert [canal]</b> - Remove o monitoramento do canal especificado. (Apenas para administradores em grupos)\n"
